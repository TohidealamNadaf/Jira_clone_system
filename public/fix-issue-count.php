...
try {
    ...
    if ($fixedCount > 0) {
        echo "<h2 style='color: #28a745;'>✅ All project issue counts have been synchronized!</h2>";
        ...
        echo "<ol>";
        echo "<li><a class='action-link' href='/jira_clone_system/public/projects' target='_blank'>Go to Projects Page</a></li>";
        ...
        echo "<h2 style='color: #28a745;'>✅ All project counts were already correct!</h2>";
    }
    
} catch (Exception $e) {
    echo "<div style='background: #f8d7da; padding: 15px; border-radius: 5px; color: #721c24; border-left: 4px solid #dc3545;'>";
    echo "<h2 style='color: #dc3545;'>❌ Error Occurred</h2>";
