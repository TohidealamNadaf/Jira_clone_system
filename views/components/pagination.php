...
<nav aria-label="Pagination" class="d-flex justify-content-between align-items-center">
    ...
    <ul class="pagination mb-0">
        ...
        <li class="page-item <?= $currentPage <= 1 ? 'disabled' : '' ?>">
            <a class="page-link" href="<?= e(buildPaginationUrl(1, $baseUrl, $queryParams)) ?>" 
               aria-label="First" <?= $currentPage <= 1 ? 'tabindex="-1"' : '' ?>>
        ...
        <?php endif; ?>
        <li class="page-item">
            <a class="page-link" href="<?= e(buildPaginationUrl($lastPage, $baseUrl, $queryParams)) ?>"><?= $lastPage ?></a>
        </li>
        <?php endif; ?>
