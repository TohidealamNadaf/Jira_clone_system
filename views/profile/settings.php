...
<div class="profile-page-wrapper">
    ...
    <div class="profile-page-header">
        <div class="profile-header-left">
            <h1 class="profile-page-title">Settings <span class="profile-page-subtitle">— Customize your profile and
                    preferences</span></h1>
        </div>
    </div>
                ...
                <div class="profile-card-body">
                    <form action="<?= url('/profile/settings') ?>" method="POST" class="profile-form">
                        ...
                        <div class="form-row-group">
                            <div class="form-field">
                                <div class="timezone-label-wrapper">
                                    ...
                                    <button type="button" class="timezone-detect-btn" id="timezoneDetectBtn"
                                ...
                                <small class="form-field-hint">Automatically detected from your device or select
                                    manually</small>
                            </div>
                            <div class="form-field">
                        ...
                        <div class="form-field settings-checkbox-group">
                            ...
                            <small class="form-field-hint">Enable automatic notification refresh every 30
                                seconds</small>
                        </div>
                ...
                <div class="profile-card-body">
                    <form action="<?= url('/profile/settings') ?>" method="POST" class="profile-form">
                        ...
                        <div class="rate-info-banner">
                            ...
                            <span>Rates calculated based on 8.5 hours/day (9:30 AM - 6:00 PM), 5 days/week, excluding
                                Sundays and public holidays</span>
                        </div>
                        ...
                        <div class="form-row-group">
                            <div class="form-field">
                                ...
                                <div class="input-with-currency">
                                    ...
                                    <input type="number" name="annual_package" class="form-field-input"
                                        id="annualPackageInput" placeholder="Enter your annual salary/package"
                                        step="100" min="0" value="<?= e($userSettings['annual_package'] ?? '') ?>">
                                </div>
                                <small class="form-field-hint" id="packageHint">Your annual salary or total package in
                                    USD</small>
                            </div>
                            <div class="form-field">
