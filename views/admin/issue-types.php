                    ...
                    <div class="issue-type-card">
                        ...
                        <div class="card-header-top">
                            <div class="icon-badge"
                                style="background-color: <?= e($type['color'] ?? '#4A90D9') ?>; color: <?= contrast_color($type['color'] ?? '#4A90D9') ?>;">
                            ...
                            <div class="card-metadata">
                                ...
                                <div class="meta-item">
                                    ...
                                    <div class="color-indicator"
                                        style="background-color: <?= e($type['color'] ?? '#4A90D9') ?>;"></div>
                                </div>
                            </div>
                        </div>
            ...
            <form id="issueTypeForm" method="POST" action="<?= url('/admin/issue-types') ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="issueTypeDescription" name="description" rows="3"
                            maxlength="500" placeholder="Describe what this issue type is used for..."></textarea>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-column">
                            ...
                            <div class="color-input-group">
                                <input type="color" class="form-control form-control-color" id="issueTypeColor"
                                    name="color" value="#4A90D9" onchange="updateColorText()">
                                <input type="text" class="form-control color-hex-input" id="issueTypeColorText"
                                    value="#4A90D9" readonly>
                            </div>
                    ...
                    <div class="form-group checkbox-group">
                        <input type="checkbox" class="form-check-input" id="issueTypeSubtask" name="is_subtask"
                            value="1">
                        <label class="form-check-label" for="issueTypeSubtask">
                            <strong>Subtask Type</strong>
                            <span class="checkbox-helper">This issue type is a subtask and appears in subtask
                                dropdowns</span>
                        </label>
                    </div>
                </div>
