...
<div class="container-fluid px-5 py-4">
    ...
    <div
        ...
        <div
            style="background: white; border: 1px solid #DFE1E6; border-radius: 8px; padding: 20px; box-shadow: 0 1px 1px rgba(9, 30, 66, 0.13), 0 0 1px rgba(9, 30, 66, 0.13);">
            <p
                style="font-size: 12px; font-weight: 600; color: #626F86; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 12px;">
                            ...
                            <?php foreach ($workload as $member): ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <?php if (!empty($member['avatar'])): ?>
                                                <img src="<?= e(avatar($member['avatar'])) ?>"
                                                    alt="<?= e($member['display_name']) ?>" class="rounded-circle me-2"
                                                    style="width: 32px; height: 32px; object-fit: cover;">
                                            <?php else: ?>
                                                <div class="rounded-circle bg-secondary me-2"
                                                    style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px;">
                                    ...
                                    <td style="text-align: center;">
                                        <span class="badge"
                                            style="background-color: var(--jira-blue-lighter); color: var(--jira-blue);">
