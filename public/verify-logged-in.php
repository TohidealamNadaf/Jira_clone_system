...
if (isset($_SESSION['user_id'])) {
    ...
    echo "<hr>";
    echo "<p><a href='/cways_mis/public/time-tracking' style='font-size: 18px; color: blue;'>👉 Try accessing Time Tracking Dashboard now</a></p>";
} else {
    ...
    echo "<hr>";
    echo "<p><a href='/cways_mis/public/login' style='font-size: 18px; color: blue;'>👉 Go to Login Page</a></p>";
}

echo "<hr>";
echo "<p><a href='/cways_mis/public/dashboard'>Back to Dashboard</a></p>";
?>