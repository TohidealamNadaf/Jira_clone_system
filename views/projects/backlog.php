...
<div class="backlog-page-wrapper">
    <div class="backlog-page-wrapper">
        ...
        <!-- Page Header (Specific to Backlog) -->
        <div class="page-header-section" style="border-top: none;">
            <div class="header-content">
                <div>
                    <!-- Removed Title as it is in the partial, but maybe kept for context? 
                     Actually the partial has the Project Title. The view might need a Page Title like "Backlog".
                     Let's keep a smaller sub-header or just the actions. -->
                    <h2 style="font-size: 20px; font-weight: 600; margin: 0;">Backlog</h2>
                </div>
                    ...
                    <div class="filter-group">
                        <div class="search-input-wrapper">
                            ...
                            <input type="text" class="filter-input" name="search"
                                value="<?= e($filters['search'] ?? '') ?>" placeholder="Search backlog items...">
                        </div>
                    </div>
                    ...
                    <tbody>
                        <?php foreach ($backlogIssues as $issue): ?>
                            <tr class="table-body-row"
                                onclick="window.location.href='<?= url("/issue/{$issue['issue_key']}") ?>'">
                                <td class="col-key">
