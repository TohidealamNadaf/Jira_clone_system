                ...
                <nav class="pagination-section">
                    <ul class="pagination">
                        <?php if ($page > 1): ?>
                            ...
                            <li><a href="?page=<?= $page - 1 ?>" class="pagination-link"><i class="bi bi-chevron-left"></i></a>
                            </li>
                        <?php endif; ?>

                        <?php for ($i = max(1, $page - 2); $i <= min($totalPages, $page + 2); $i++): ?>
                            <li><a href="?page=<?= $i ?>"
                                    class="pagination-link <?= $i === $page ? 'active' : '' ?>"><?= $i ?></a></li>
                        <?php endfor; ?>

                        <?php if ($page < $totalPages): ?>
                            <li><a href="?page=<?= $page + 1 ?>" class="pagination-link"><i class="bi bi-chevron-right"></i></a>
                            </li>
                            <li><a href="?page=<?= $totalPages ?>" class="pagination-link"><i
                                        class="bi bi-chevron-bar-right"></i></a></li>
                        <?php endif; ?>
                    </ul>
                </nav>
            <?php endif; ?>
