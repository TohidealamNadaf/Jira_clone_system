...
<div class="profile-page-wrapper">
    ...
    <div class="profile-page-header">
        <div class="profile-header-left">
            <h1 class="profile-page-title">Account Settings <span class="profile-page-subtitle">— Manage your profile, security, and preferences</span></h1>
        </div>
    </div>
            ...
            <div class="profile-sidebar-content">
                ...
                <div class="profile-user-card">
                    <div class="user-avatar-wrapper">
                        ...
                        <?php endif; ?>
                        <button class="avatar-upload-btn" title="Change avatar" data-bs-toggle="modal" data-bs-target="#avatarModal">
                ...
                <div class="profile-card-body">
                    <form action="<?= url('/profile') ?>" method="POST" class="profile-form">
                        ...
                        <div class="form-field">
                            ...
                            <input type="email" name="email" class="form-field-input" 
                                   value="<?= e($user['email']) ?>" 
                ...
                <div class="profile-card-body">
                    <div class="activity-stats-grid">
                        <div class="activity-stat-card">
                            <div class="activity-stat-icon" style="background-color: rgba(139, 25, 86, 0.1); color: #8B1956;">
                        ...
                        <div class="activity-stat-card">
                            <div class="activity-stat-icon" style="background-color: rgba(54, 179, 126, 0.1); color: #36B37E;">
                        ...
                        <div class="activity-stat-card">
                            <div class="activity-stat-icon" style="background-color: rgba(255, 171, 0, 0.1); color: #FFAB00;">
                        ...
                        <div class="activity-stat-card">
                            <div class="activity-stat-icon" style="background-color: rgba(0, 184, 217, 0.1); color: #00B8D9;">
            ...
            <div id="avatarStep2" style="display: none;">
                <div class="modal-body">
                    ...
                    <div class="crop-zoom-control">
                        ...
                        <input type="range" id="zoomSlider" class="crop-zoom-slider" min="1" max="3" step="0.1" value="1">
                    </div>
                </div>
                <div class="modal-footer">
