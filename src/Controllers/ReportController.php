...
class ReportController extends Controller
{
    ...
    {
        $sprintId = (int) $request->param('sprintId');
        ...
        // Get all projects and sprints for the selectors
        ...
        return $this->view('reports.burndown', [
            ...
            'sprintData' => [
                'total_points' => $totalPoints,
                'completed' => array_sum(array_column($burndownData, 'completed')),
                'remaining' => end($burndownData)['remaining'] ?? $totalPoints,
            ],
