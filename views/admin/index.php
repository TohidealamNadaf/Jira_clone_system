        ...
        <div class="health-sections">
            ...
            <div class="health-card">
                ...
                <div class="health-grid">
                    ...
                    <div class="health-item">
                        <div class="health-icon <?= $errorStats['total_errors'] > 0 ? 'health-danger' : 'health-success' ?>">
                            <i class="bi bi-exclamation-circle"></i>
                        </div>
                        <div class="health-info">
                            <div class="health-label">Errors (24h)</div>
                            <div class="health-status <?= $errorStats['total_errors'] > 0 ? 'health-danger' : 'health-success' ?>">
                    ...
                    <div class="health-item">
                        ...
                        <div class="health-info">
                            ...
                            <div class="health-status health-info-blue"><?= e($errorStats['retry_count'] ?? 0) ?> queued</div>
                        </div>
                    </div>
                    <div class="health-item">
                        ...
                        <div class="health-info">
                            ...
                            <div class="health-status health-gray"><?= \App\Helpers\NotificationLogger::getLogFileSizeFormatted() ?></div>
                        </div>
                    </div>
                </div>
