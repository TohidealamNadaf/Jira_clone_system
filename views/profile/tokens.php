...
<div class="profile-page-wrapper">
    ...
    <div class="profile-page-header">
        <div class="profile-header-left">
            <h1 class="profile-page-title">API Tokens <span class="profile-page-subtitle">— Manage your personal API
                    tokens for third-party integrations</span></h1>
        </div>
    </div>
                ...
                <div class="profile-card-header">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div>
                            ...
                            <p class="profile-section-description">Manage your personal API tokens for authentication
                            </p>
                        </div>
                ...
                <div class="profile-card-body">
                    <div class="token-info-box">
                        ...
                        <div>
                            ...
                            <p>API tokens allow you to authenticate with the API without using your password. Treat them
                                like passwords and keep them secure.</p>
                        </div>
                    </div>
                        ...
                        <div class="token-success-box">
                            ...
                            <div>
                                ...
                                <div class="token-copy-group">
                                    <input type="text" class="token-copy-input" value="<?= e($newToken) ?>" readonly
                                        id="newTokenValue">
                                ...
                                <div class="token-item">
                                    <div class="token-item-header">
                                        <div class="token-item-info">
                                            ...
                                            <code
                                                class="token-item-preview"><?= e(substr($token['token_preview'] ?? '****', 0, 12)) ?>...</code>
                                        </div>
                                    ...
                                    <div class="token-item-details">
                                        ...
                                        <div class="token-detail">
                                            ...
                                            <span
                                                class="detail-value <?= (!empty($token['expires_at']) && strtotime($token['expires_at']) < time()) ? 'detail-expired' : '' ?>">
                ...
                <div class="profile-card-body">
                    <div class="documentation-box">
                        ...
                        <div class="documentation-content">
                            ...
                            <p class="documentation-description">Learn how to use the API to integrate with your
                                applications.</p>
                        </div>
                    ...
                    <div class="form-field">
                        ...
                        <div class="scope-options">
                            <div class="scope-item">
                                <input class="form-check-input" type="checkbox" name="scopes[]" value="*" id="scope-all"
                                    checked>
                            ...
                            <div class="scope-item">
                                <input class="form-check-input" type="checkbox" name="scopes[]" value="read:issues"
                                    id="scope-read-issues">
                                <label class="form-check-label" for="scope-read-issues">Read Issues</label>
                            </div>
                            <div class="scope-item">
                                <input class="form-check-input" type="checkbox" name="scopes[]" value="write:issues"
                                    id="scope-write-issues">
                                <label class="form-check-label" for="scope-write-issues">Write Issues</label>
                            </div>
                            <div class="scope-item">
                                <input class="form-check-input" type="checkbox" name="scopes[]" value="read:projects"
                                    id="scope-read-projects">
                                <label class="form-check-label" for="scope-read-projects">Read Projects</label>
                            </div>
                            <div class="scope-item">
                                <input class="form-check-input" type="checkbox" name="scopes[]" value="write:projects"
                                    id="scope-write-projects">
