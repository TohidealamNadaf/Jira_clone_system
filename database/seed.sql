...
('Open', 'New issue waiting to start', 'todo', '#E5E5E5', 1),
('To Do', 'Queued for development', 'todo', '#E5E5E5', 2),
('In Progress', 'Currently being worked on', 'in_progress', '#FEC57B', 3),
('In Review', 'Waiting for code review', 'in_progress', '#85E1AD', 4),
('Testing', 'In QA testing phase', 'in_progress', '#4ECDC4', 5),
('Done', 'Completed and released', 'done', '#36B37E', 6),
('Closed', 'Issue closed/resolved', 'done', '#626F86', 7);
