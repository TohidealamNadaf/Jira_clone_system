...
<div class="container-fluid px-5 py-4">
    ...
    <div style="background: white; border: 1px solid #DFE1E6; border-radius: 8px; overflow: hidden; box-shadow: 0 1px 1px rgba(9, 30, 66, 0.13), 0 0 1px rgba(9, 30, 66, 0.13);">
        <div style="padding: 24px;">
            <h6 style="font-size: 12px; font-weight: 600; color: #626F86; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 16px;">Time Logged by Team Member</h6>
        </div>
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img src="<?= e($user['avatar']) ?>" alt="<?= e($user['display_name']) ?>" 
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="3" style="text-align: center; color: #626F86; padding: 40px 20px;">No time logged</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
