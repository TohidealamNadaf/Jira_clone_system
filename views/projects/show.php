...
<div class="jira-project-wrapper">
    ...
    <div class="quick-actions-bar">
        <a href="#" class="btn-quick-action primary open-create-issue-modal"
            data-project-key="<?= e($project['key']) ?>">
                ...
                <div class="issues-container">
                    <?php if (empty($recentIssues)): ?>
                        <div class="empty-state">
                            ...
                            <p>No issues yet</p>
                            <a href="#" class="empty-link open-create-issue-modal"
                                data-project-key="<?= e($project['key']) ?>">Create the first one</a>
                        </div>
                    <?php else: ?>
                ...
                <?php else: ?>
                    <div class="members-grid">
                        <?php foreach (array_slice($members ?? [], 0, 6) as $member): ?>
                            ...
                            if (!empty($avatarUrl)): ?>
                                <img src="<?= e($avatarUrl) ?>" class="member-avatar" title="<?= e($member['display_name']) ?>"
                                    onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                            ...
                            <?php else: ?>
                                <div class="member-avatar-placeholder" title="<?= e($member['display_name']) ?>">
                                    <?= avatarInitials($member['display_name'] ?? 'User', $member['email'] ?? '') ?>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
