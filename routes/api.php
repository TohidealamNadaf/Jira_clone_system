...
$router->group(['prefix' => '/api/v1'], function ($router) {
    ...
    $router->group(['middleware' => ['api', 'throttle:300,1']], function ($router) {
        ...
        // Watchers
        $router->post('/issues/{key}/watch', [CalendarController::class, 'toggleWatch']);
        $router->get('/issues/{key}/watch', [CalendarController::class, 'checkWatchStatus']);
        ...
        $router->get('/calendar-events/priorities', [CalendarEventController::class, 'getPriorities']);
        $router->get('/calendar-events/users', [CalendarEventController::class, 'getUsers']);
        $router->get('/calendar-events', [CalendarEventController::class, 'getEvents']);
        $router->post('/calendar-events', [CalendarEventController::class, 'create']);
        $router->put('/calendar-events/{id}', [CalendarEventController::class, 'update']);
        $router->delete('/calendar-events/{id}', [CalendarEventController::class, 'delete']);
